...
namespaces = [{'/dhcp': ['', '@xmlns="urn:huawei:yang:huawei-dhcp"', '/dhcp']}, {'/network-instance': ['', '@xmlns="urn:huawei:yang:huawei-network-instance"', '/network-instance']}, {'/dhcp/relay': ['', '', '/dhcp/relay']}, {'/network-instance/instances': ['', '', '/network-instance/instances']}, {'/dhcp/relay/global': ['', '', '/dhcp/relay/global']}, {'/network-instance/instances/instance': [[OrderedDict([('name', None), ('bgp', OrderedDict([('@xmlns', 'urn:huawei:yang:huawei-bgp'), ('base-process', OrderedDict([('peers', OrderedDict([('peer', OrderedDict([('address', None), ('afs', OrderedDict([('af', OrderedDict([('type', None), ('ipv6-vpn', OrderedDict([('route-update-interval', None), ('public-as-only', OrderedDict([('enable', None)])), ('public-as-only-import', OrderedDict([('enable', None)]))]))]))]))]))]))]))]))]), OrderedDict([('name', None), ('afs', OrderedDict([('@xmlns', 'urn:huawei:yang:huawei-l3vpn'), ('af', OrderedDict([('type', None), ('vpn-ttlmode', OrderedDict([('@xmlns', 'urn:huawei:yang:huawei-mpls-forward'), ('ttlmode', None)]))]))])), ('bgp', OrderedDict([('@xmlns', 'urn:huawei:yang:huawei-bgp'), ('base-process', OrderedDict([('afs', OrderedDict([('af', OrderedDict([('type', None), ('ipv6-unicast', OrderedDict([('common', OrderedDict([('router-id-auto-select', None), ('auto-frr', None), ('maximum-load-balancing-ibgp', None), ('maximum-load-balancing-ebgp', None), ('nexthop-resolve-aigp', None), ('supernet-unicast-advertise', None), ('bestroute-as-path-ignore', None), ('determin-med', None), ('attribute-set-enable', None), ('load-balanc-igp-metric-ignore', None), ('load-balanc-as-path-ignore', None), ('load-balanc-as-path-relax', None), ('maximum-load-balancing', None), ('best-route-bit-error-detection', None), ('import-rib-nexthop-invariable', None), ('route-relay-tunnel-v4', None), ('bestroute-med-plus-igp', None), ('bestroute-igp-metric-ignore', None), ('bestroute-router-id-prior-clusterlist', None), ('bestroute-med-none-as-maximum', None), ('load-balancing-eibgp-enable', None), ('prefix-origin-as-validation', None), ('advertise-route-mode', None), ('route-select-delay', None), ('reflect-change-path', None), ('always-compare-med', None), ('default-med', None), ('nexthop-third-party', None), ('default-local-preference', None), ('default-route-import', None), ('routerid-neglect', None), ('reflect-between-client', None), ('ext-community-change', None), ('active-route-advertise', None), ('ebgp-interface-sensitive', None)])), ('preference', OrderedDict([('external', None), ('internal', None), ('local', None)])), ('nexthop-recursive-lookup', OrderedDict([('common', OrderedDict([('restrain', None), ('default-route', None)]))])), ('import-routes', OrderedDict([('import-route', [OrderedDict([('protocol', None), ('process-id', None)]), OrderedDict([('protocol', None), ('process-id', None), ('policy-name', None)])])])), ('slow-peer', OrderedDict([('detection', None), ('detection-threshold', None), ('absolute-detection', None), ('absolute-detection-threshold', None)])), ('routing-table-rib-only', OrderedDict([('enable', None)])), ('qos', OrderedDict([('ipv6-qppb', None)]))]))]))])), ('peers', OrderedDict([('peer', OrderedDict([('address', None), ('remote-as', None), ('ebgp-max-hop', None), ('timer', OrderedDict([('keep-alive-time', None), ('hold-time', None), ('min-hold-time', None), ('connect-retry-time', None)])), ('graceful-restart', OrderedDict([('enable', None), ('peer-reset', None)])), ('local-graceful-restart', OrderedDict([('enable', None)])), ('afs', OrderedDict([('af', OrderedDict([('type', None), ('ipv6-unicast', OrderedDict([('import-policy', None), ('export-policy', None), ('route-update-interval', None), ('public-as-only', OrderedDict([('enable', None)])), ('public-as-only-import', OrderedDict([('enable', None)]))]))]))]))]))]))]))]))])], '', '/network-instance/instances/instance']}, {'/dhcp/relay/global/user-detect-interval': ['', '', '/dhcp/relay/global/user-detect-interval']}, {'/dhcp/relay/global/user-autosave-flag': ['', '', '/dhcp/relay/global/user-autosave-flag']}, {'/dhcp/relay/global/user-store-interval': ['', '', '/dhcp/relay/global/user-store-interval']}, {'/dhcp/relay/global/distribute-flag': ['', '', '/dhcp/relay/global/distribute-flag']}, {'/dhcp/relay/global/opt82-inner-vlan-insert-flag': ['', '', '/dhcp/relay/global/opt82-inner-vlan-insert-flag']}]

business_tag = ['dhcp', 'network-instance']

# Passed to the ansible parameter
argument_spec = OrderedDict([('dhcp', {'type': 'dict', 'options': OrderedDict([('relay', {'type': 'dict', 'options': OrderedDict([('global', {'type': 'dict', 'options': OrderedDict([('user-detect-interval', {'type': 'int', 'default': 20, 'required': False}), ('user-autosave-flag', {'type': 'bool', 'required': False}), ('user-store-interval', {'type': 'int', 'default': 300, 'required': False}), ('distribute-flag', {'type': 'bool', 'required': False}), ('opt82-inner-vlan-insert-flag', {'type': 'bool', 'required': False})])})])})])}), ('network-instance', {'type': 'dict', 'options': OrderedDict([('instances', {'type': 'list', 'elements': 'dict', 'options': OrderedDict([('instance', {'type': 'dict', 'options': OrderedDict([('bgp', {'type': 'dict', 'options': OrderedDict([('base-process', {'type': 'dict', 'options': OrderedDict([('afs', {'type': 'dict', 'options': OrderedDict([('af', {'type': 'dict', 'options': OrderedDict([('ipv6-unicast', {'type': 'dict', 'options': OrderedDict([('nexthop-recursive-lookup', {'type': 'dict', 'options': OrderedDict()}), ('import-routes', {'type': 'dict', 'options': OrderedDict()})])})])})])}), ('peers', {'type': 'dict', 'options': OrderedDict([('peer', {'type': 'dict', 'options': OrderedDict([('afs', {'type': 'dict', 'options': OrderedDict([('af', {'type': 'dict', 'options': OrderedDict([('ipv6-unicast', {'type': 'dict', 'options': OrderedDict()})])})])})])})])})])})])}), ('afs', {'type': 'dict', 'options': OrderedDict([('af', {'type': 'dict', 'options': OrderedDict()})])})])})])})])})])
...
leaf_info =  OrderedDict([('dhcp', OrderedDict([('relay', OrderedDict([('global', OrderedDict([('user-detect-interval', {
            ...
            ('opt82-inner-vlan-insert-flag', {
                ...
                'pattern': [], 
                'key': False})]))]))])), 
            ('network-instance', OrderedDict([('instances', OrderedDict([('instance', OrderedDict([('bgp', OrderedDict([('base-process', OrderedDict([('afs', OrderedDict([('af', OrderedDict([('ipv6-unicast', OrderedDict([('common', OrderedDict()), 
            ...
            ('afs', OrderedDict([('af', OrderedDict([('ipv6-unicast', OrderedDict([('public-as-only', OrderedDict()), 
