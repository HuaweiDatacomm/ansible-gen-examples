...
# Keyword list
key_list = ['/network-instance/instances/instance/name', '/network-instance/instances/instance/afs/af/type']
...
argument_spec = OrderedDict([('dhcp', {'type': 'dict', 'options': OrderedDict([('relay', {'type': 'dict', 'options': OrderedDict([('global', {'type': 'dict', 'options': OrderedDict([('user-detect-interval', {'type': 'int', 'default': 20, 'required': False}), ('user-autosave-flag', {'type': 'bool', 'required': False}), ('user-store-interval', {'type': 'int', 'default': 300, 'required': False}), ('distribute-flag', {'type': 'bool', 'required': False}), ('opt82-inner-vlan-insert-flag', {'type': 'bool', 'required': False})])})])})])}), ('network-instance', {'type': 'dict', 'options': OrderedDict([('instances', {'type': 'list', 'elements': 'dict', 'options': OrderedDict([('instance', {'type': 'dict', 'options': OrderedDict([('name', {'type': 'str', 'required': True}), ('afs', {'type': 'list', 'elements': 'dict', 'options': OrderedDict([('af', {'type': 'dict', 'options': OrderedDict([('type', {'choices': ['ipv4-unicast', 'ipv6-unicast'], 'required': True}), ('route-distinguisher', {'type': 'str', 'required': False}), ('label-mode', {'type': None, 'required': False}), ('vpn-targets', {'type': 'dict', 'options': OrderedDict([('vpn-target', {'type': 'dict', 'options': OrderedDict([('value', {'type': None, 'required': False}), ('type', {'type': None, 'required': False})])})])}), ('routing', {'type': 'dict', 'options': OrderedDict([('routing-manage', {'type': 'dict', 'options': OrderedDict([('option', {'type': 'dict', 'options': OrderedDict([('frr-enable', {'type': None, 'required': False})])}), ('topologys', {'type': 'dict', 'options': OrderedDict([('topology', {'type': 'dict', 'options': OrderedDict([('name', {'type': None, 'required': False})])})])})])})])}), ('vpn-ttlmode', {'type': 'dict', 'options': OrderedDict([('ttlmode', {'type': None, 'required': False})])})])})])})])})])})])})])
